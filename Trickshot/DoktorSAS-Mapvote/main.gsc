...
baseText(){
	self.textMAP1 SetElementText( level.maptovote["map"][0] + " ^5|^7 Vote:^5 " + level.maptovote["vote"][0] );		
	self.textMAP2 SetElementText( level.maptovote["map"][1] + " ^5|^7 Vote:^5 " + level.maptovote["vote"][1] );		
	self.textMAP3 SetElementText( level.maptovote["map"][2] + " ^5|^7 Vote:^5 " + level.maptovote["vote"][2] );		
}
...
buttonsmonitor(){
	...
	i = 0;
	wait 0.05;
	self.textMAP1 SetElementText( "^5<<^7"+ level.maptovote["map"][0] + " ^5|^7 Vote:^5 " + level.maptovote["vote"][0] + "^5>>" );		
	for(;;){
		wait 0.05;
		if(self adsbuttonpressed()){
			...
			if(i == 0){
				...
				self.textMAP2 SetElementText( "^5<<^7"+ level.maptovote["map"][1] + " ^5|^7 Vote:^5 " + level.maptovote["vote"][1] + "^5>>" );		
			}else if(i == 2){
				self.textMAP3 SetElementText( "^5<<^7"+ level.maptovote["map"][2] + " ^5|^7 Vote:^5 " + level.maptovote["vote"][2] + "^5>>" );		
			}
			wait 0.25;
		}
